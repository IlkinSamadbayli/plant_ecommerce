...
class HomeProvider extends ChangeNotifier {
  ...
  List<ProductModel> favorCards = [];

  void addFavor(ProductModel item) {
    item.isFavorite = !item.isFavorite;
    if (item.isFavorite) {
      favorCards.add(item);
    } else if (item.isFavorite == false) {
      favorCards.remove(item);
    }
    notifyListeners();
  }
  ...
  List<ProductModel> productData_1 = [
    ProductModel(
      title: "Chinese Money",
      image: Image.asset(
        GlobalAssets.card_1,
  ...
  List<ProductModel> productData_2 = [
    ProductModel(
      title: "Aloe Vera",
      image: Image.asset(
        GlobalAssets.card_4,
  ...
  List<ProductModel> productData_3 = [
    ProductModel(
      title: "Orchid",
      image: Image.asset(
        GlobalAssets.card_7,
